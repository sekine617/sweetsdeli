...
ActiveRecord::Schema.define(version: 2021_02_14_073807) do
  ...
  create_table "product_category_relations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.bigint "product_id"
